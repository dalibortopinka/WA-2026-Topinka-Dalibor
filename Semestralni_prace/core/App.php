...
class App {
    ...
    protected $controller = 'CleatController'; // Změna z BookController na CleatController
    protected $method = 'index'; // Výchozí metoda typicky zobrazuje seznam (seznam inzerátů)
    protected $params = [];
    ...
    public function __construct() {
        ...
        // Příklad: Pokud je URL "cleat/create", hledá se "CleatController.php"
        ...
        // Příklad: Pokud je URL "cleat/create", hledá se funkce "create()" uvnitř CleatControlleru
        if (isset($url[1])) {
        ...
        // 3. PARAMETRY: Vše, co v URL zbylo, se bere jako parametry (např. ID inzerátu)
