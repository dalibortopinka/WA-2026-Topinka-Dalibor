...
class User {
    ...
    // 1. Registrace nového uživatele (role se nastaví automaticky v DB na 'user')
    ...
    public function findById(int $id) {
        // ZDE JE ZMĚNA: Přidali jsme sloupec 'role', abychom mohli ověřovat práva admina
    ...
    // 4. NOVÁ METODA: Smazání uživatelského profilu z databáze (Bod 2 ze zadání)
