...
public function store() {
    ...
    public function update($id = null) {
        ...
        if ($book['created_by'] !== $_SESSION['user_id'] && !$isAdmin) {
          ...
          // 1. Získání ID přihlášeného uživatele ze session
$updated_by = $_SESSION['user_id'];

// 2. Přidání $updated_by na konec seznamu proměnných
$isUpdated = $bookModel->update(
    $id, $title, $author, $category, $subcategory, 
    $year, $price, $isbn, $description, $link, $uploadedImages, $updated_by
);
